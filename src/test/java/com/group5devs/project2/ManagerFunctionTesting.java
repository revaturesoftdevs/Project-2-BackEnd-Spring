...
import com.group5devs.project2.exceptions.ApplicationException;
...
public class ManagerFunctionTesting {
	...
	@Test
	public void testLogin() throws ApplicationException, SystemException {
	...
	@DisplayName("JUnit test for Manager View All Pending Reimbursements")
	@Test
	public void testViewAllPending() {
		
		when(dao.findAllPendingReimbursementStatusAndMgrId(9)).thenReturn(viewPendingReimb);
